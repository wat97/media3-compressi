...
import dev.wat.vidsqueeze.core.internal.CapabilityResolver
import dev.wat.vidsqueeze.core.internal.CompressionPlan
import dev.wat.vidsqueeze.core.internal.CompressionPolicyEngine
import dev.wat.vidsqueeze.core.internal.ErrorClassifier
import dev.wat.vidsqueeze.core.internal.FallbackPlanner
import dev.wat.vidsqueeze.core.internal.OutputValidator
import dev.wat.vidsqueeze.core.internal.SourceInspector
import dev.wat.vidsqueeze.core.internal.TransformerRunner
...
class VideoCompressor private constructor(
    ...
    private fun shouldKeepOriginalSource(
        request: CompressionRequest,
        source: dev.wat.vidsqueeze.core.internal.SourceVideoInfo,
        compressedFile: File,
    ): Boolean {
